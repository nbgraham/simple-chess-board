...
## Quickstart
 ...
 - Open two browser windows, one for white and one for black
    - May be on different clients if you use the "On Your Network" URL and specifiy the [API URL in the UI source](src/api_client.ts#L7) to point to that IP instead of localhost
- Play Chess!
